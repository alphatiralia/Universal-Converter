...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        root.minsize(width = 636, height = 393)
        root.maxsize(width = 636, height = 393)
        root.configure(bg='black') #Change color of window
        #Create the label
        # self.frame = Frame(root, relief = RAISED).grid(row = 0, column = 0, columnspan = 4) 
        Label(root, text = "================ Choose the measurements ================", fg = "white", bg = "black", font = tkFont.Font(family = "Trebuchet MS", size = 20, weight = tkFont.BOLD), relief = FLAT).grid(row = 0, column = 0, columnspan = 4, ipadx = 20, ipady = 20, pady = 20)
        #Create the button
        ...
        for i in range(4):
            Button(root, text = self.measurements_list[i], width = 13, bd = 0, fg = "white", bg = "#444444", font = tkFont.Font(family = "Trebuchet MS", size = 12), command = self.measurements_dict[self.measurements_list[i]], relief = FLAT, activeforeground = "#444444", activebackground = "white").grid(row = 1, column = i, ipady = 15, ipadx = 15, padx = 3, pady = 3)
        for i in range(4, 8):
            Button(root, text = self.measurements_list[i], width = 13, bd = 0, fg = "white", bg = "#444444", font = tkFont.Font(family = "Trebuchet MS", size = 12), command = self.measurements_dict[self.measurements_list[i]], relief = FLAT, activeforeground = "#444444", activebackground = "white").grid(row = 2, column = (i - 4), ipady = 15, ipadx = 15, padx = 3, pady = 3)
        for i in range(8, 12):
            Button(root, text = self.measurements_list[i], width = 13, bd = 0, fg = "white", bg = "#444444", font = tkFont.Font(family = "Trebuchet MS", size = 12), command = self.measurements_dict[self.measurements_list[i]], relief = FLAT, activeforeground = "#444444", activebackground = "white").grid(row = 3, column = (i - 8), ipady = 15, ipadx = 15, padx = 3, pady = 3)
        for i in range(12, 16):
            Button(root, text = self.measurements_list[i], width = 13, bd = 0, fg = "white", bg = "#444444", font = tkFont.Font(family = "Trebuchet MS", size = 12), command = self.measurements_dict[self.measurements_list[i]], relief = FLAT, activeforeground = "#444444", activebackground = "white").grid(row = 4, column = (i - 12), ipady = 15, ipadx = 15, padx = 3, pady = 3)
...
class Angle(object):
    ...
    def create_widgets(self):
        ...
        #Create the label
        Label(top, text = "Enter the current value", fg = "white", bg = "black", font = tkFont.Font(family = "Trebuchet MS", size = 12), pady = 10).pack()
        ...
        Label(top, text = "Choose the current unit", fg = "white", bg = "black", font = tkFont.Font(family = "Trebuchet MS", size = 12), pady = 10).pack()
        self.dropdown = ttk.Combobox(top, state = "readonly", values=["arcminute", "arcsecond", "circle", "degree", "gon", "gradian", "mil(Nato)", "mil(Soviet Union)", "mil(Sweden)", "octant", "quadrant", "radian", "revolution", "sextant", "sign", "turn"])
        self.dropdown.pack()
        self.dropdown.set("arcminute")
        #Create the separator between input and output section
        Frame(top, height=2, bd=0, background = "black", relief=SUNKEN).pack(fill=X, ipady = 10)
        ...
        #Make the program auto calculate
        top.bind("<Key>", self.change_to_other_unit)
        top.bind("<Enter>", self.change_to_other_unit)
    
    def change_to_other_unit(self, event):
        ...
        try:
            ...
            value_comp, printer = self.v.get() * unit_comp[self.dropdown.get()], ""
            ...
            printer = "Please enter the current value (Integer of Float)."
...
class Area(object):
    ...
    def create_widgets(self):
        ...
        Label(top, text = "Choose the current unit", fg = "white", bg = "black", font = tkFont.Font(family = "Trebuchet MS", size = 12), pady = 10).pack()
        self.dropdown = ttk.Combobox(top, state = "readonly", values=["acres", "ares", "circular inches", "hectares", "hides", "roods", "square centimeters", "square feet(US & UK)", "square feet(US survey)", "square inches", "square kilometers", "square meters", "square miles", "square millimeters", "square of timber", "square rods or poles", "square yards", "townships"])
        self.dropdown.pack()
        self.dropdown.set("acres")
        #Create the separator between input and output section
        Frame(top, height=2, bd=0, background = "black", relief=SUNKEN).pack(fill=X, ipady = 10) 
        Frame(top, height=2, bd=1, relief=SUNKEN).pack(fill=X)
        #Create the scroll bar
...
class Bitbyte(object):
    ...
    def create_widgets(self):
        ...
        Label(top, text = "Choose the current unit", fg = "white", bg = "black", font = tkFont.Font(family = "Trebuchet MS", size = 12), pady = 10).pack()
        self.dropdown = ttk.Combobox(top, state = "readonly", values=["bits", "bytes", "exabits", "exabytes", "gigabits", "gigabytes", "kilobits", "kilobytes", "megabits", "megabytes", "petabits", "petabytes", "terabits", "terabytes"])
        self.dropdown.pack()
        self.dropdown.set("bits")
        #Create the separator between input and output section
        Frame(top, height=2, bd=0, background = "black", relief=SUNKEN).pack(fill=X, ipady = 10) 
        Frame(top, height=2, bd=1, relief=SUNKEN).pack(fill=X)
        #Create the scroll bar
...
class Force(object):
    ...
    def create_widgets(self):
        ...
        Label(top, text = "Choose the current unit", fg = "white", bg = "black", font = tkFont.Font(family = "Trebuchet MS", size = 12), pady = 10).pack()
        self.dropdown = ttk.Combobox(top, state = "readonly", values=["dynes", "kilograms force", "kilonewtons", "kips", "meganewtons", "newtons", "poundals", "pounds force", "sthene", "tonnes force", "tons force(UK)", "tons force(US)"])
        self.dropdown.pack()
        self.dropdown.set("dynes")
        #Create the separator between input and output section
        Frame(top, height=2, bd=0, background = "black", relief=SUNKEN).pack(fill=X, ipady = 10) 
        Frame(top, height=2, bd=1, relief=SUNKEN).pack(fill=X)
        #Create the scroll bar
...
class Fuelconsumption(object):
    ...
    def create_widgets(self):
        ...
        Label(top, text = "Choose the current unit", fg = "white", bg = "black", font = tkFont.Font(family = "Trebuchet MS", size = 12), pady = 10).pack()
        self.dropdown = ttk.Combobox(top, state = "readonly", values=["car(2014 US Average)", "gallon(UK)/100 miles", "gallon(US)/100 miles", "kilometer/liter", "liters/100 kilometer", "liters/meter", "miles/gallon(UK)", "miles/gallon(US)"])
        self.dropdown.pack()
        self.dropdown.set("car(2014 US Average)")
        #Create the separator between input and output section
        Frame(top, height=2, bd=0, background = "black", relief=SUNKEN).pack(fill=X, ipady = 10) 
        Frame(top, height=2, bd=1, relief=SUNKEN).pack(fill=X)
        #Create the scroll bar
...
class Length(object):
    ...
    def create_widgets(self):
        ...
        Label(top, text = "Choose the current unit", fg = "white", bg = "black", font = tkFont.Font(family = "Trebuchet MS", size = 12), pady = 10).pack()
        self.dropdown = ttk.Combobox(top, state = "readonly", values=["Scandinavian mile", "angstroms", "au", "barleycorns", "cables", "centimeters", "chains", "decimeters", "ells", "ems", "fathoms", "feet(UK & US)", "feet(US survey)", "furlongs", "hands", "hectometers", "inches", "kilometers", "links", "light years", "meters", "micrometers", "mil", "miles(UK & US)", "miles(nautical, UK)", "miles(nautical, international)", "millimeters", "nanometers", "parsecs", "pica", "picometers", "rods", "spans", "thou", "yards"])
        self.dropdown.pack()
        self.dropdown.set("Scandinavian mile")
        #Create the separator between input and output section
        Frame(top, height=2, bd=0, background = "black", relief=SUNKEN).pack(fill=X, ipady = 10) 
        Frame(top, height=2, bd=1, relief=SUNKEN).pack(fill=X)
        #Create the scroll bar
...
class Temperature(object):
    ...
    def create_widgets(self):
        ...
        Label(top, text = "Choose the current unit", fg = "white", bg = "black", font = tkFont.Font(family = "Trebuchet MS", size = 12), pady = 10).pack()
        self.dropdown = ttk.Combobox(top, state = "readonly", values=["Celsius", "Fahrenheit", "Kelvin", "Rankine", "Reaumur", "Newton", "Romer", "Delisle"])
        self.dropdown.pack()
        self.dropdown.set("Celsius")
        #Create the separator between input and output section
        Frame(top, height=2, bd=0, background = "black", relief=SUNKEN).pack(fill=X, ipady = 10) 
        Frame(top, height=2, bd=1, relief=SUNKEN).pack(fill=X)
        #Create the scroll bar
    ...
    def change_to_other_unit(self, event):
        ...
        try:
            ...
            new_value = {"Celsius": unit_comp[self.dropdown.get()], "Fahrenheit": unit_comp[self.dropdown.get()] * 1.8 + 32, "Kelvin": unit_comp[self.dropdown.get()] + 273.15, "Reaumur": unit_comp[self.dropdown.get()] * 0.8, "Rankine": unit_comp[self.dropdown.get()] * 1.8 + 491.67, "Newton": unit_comp[self.dropdown.get()] * 0.33, "Romer": unit_comp[self.dropdown.get()] * 0.525 + 7.5, "Delisle": (100 - unit_comp[self.dropdown.get()]) * 1.5}
            printer = ""
            unit_list = sorted(unit_comp.keys())
            for unit in unit_list:
...
class Time(object):
    ...
    def create_widgets(self):
        ...
        Label(top, text = "Choose the current unit", fg = "white", bg = "black", font = tkFont.Font(family = "Trebuchet MS", size = 12), pady = 10).pack()
        self.dropdown = ttk.Combobox(top, state = "readonly", values=["centuries", "days", "decades", "femtoseconds", "fortnights", "hours", "microseconds", "millenia", "milliseconds", "minutes", "months(Common)", "months(Synodic)", "nanoseconds", "picoseconds", "quarters(Common)", "seconds", "shakes", "weeks", "years(Average Gregorian)", "years(Common)", "years(Julian)", "years(Leap)", "years(Tropical)"])
        self.dropdown.pack()
        self.dropdown.set("centuries")
        #Create the separator between input and output section
        Frame(top, height=2, bd=0, background = "black", relief=SUNKEN).pack(fill=X, ipady = 10) 
        Frame(top, height=2, bd=1, relief=SUNKEN).pack(fill=X)
        #Create the scroll bar
...
class Volume(object):
    ...
    def create_widgets(self):
        ...
        Label(top, text = "Choose the current unit", fg = "white", bg = "black", font = tkFont.Font(family = "Trebuchet MS", size = 12), pady = 10).pack()
        self.dropdown = ttk.Combobox(top, state = "readonly", values=["acre foot", "barrels", "bushels(UK)", "bushels(US)", "centiliters", "cubic centimeters", "cubic decameters", "cubic decimeters", "cubic feet", "cubic inches", "cubic kilometers", "cubic meters", "cubic mile", "cubic millimeters", "cubic yards", "cups", "deciliters", "dram", "dram(imperial)", "fluid ounces(US)", "fluid ounces(imperial)", "gallons(US,dry)", "gallons(US,liquid)", "gallons(imperial)", "gill(US)", "gill(imperial)", "liters", "liters(1901-1964)", "microliters", "milliliters", "nanoliters", "picoliters", "pints(US,dry)", "pints(US,liquid)", "pints(imperial)", "quarts(UK,dry)", "quarts(US,liquid)", "quarts(imperial)", "table spoons", "tea spoons"])
        self.dropdown.pack()
        self.dropdown.set("acre foot")
        #Create the separator between input and output section
        Frame(top, height=2, bd=0, background = "black", relief=SUNKEN).pack(fill=X, ipady = 10) 
        Frame(top, height=2, bd=1, relief=SUNKEN).pack(fill=X)
        #Create the scroll bar
